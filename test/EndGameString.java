/**
 * This is basically just a class to contain the string for the end-game sequence that I test.
 */
public class EndGameString {
  String endGameString;

  /**
   * Constructs the endGameString to use in a test.
   */
  public EndGameString() {
    this.endGameString =
            "F1:\n" +
                    "F2:\n" +
                    "F3:\n" +
